<?php
  ...
  // si l'id est définit, alors on est en mode édition
  if ($id) { 
  ...
  // vérification si on est en mode post
        ...
        <form action="/form-article.php<?= $id ? "?id=$id" : "" ?>" method="POST">
          ...
          <div class="form-control">
            ...
            <select name="category" id="category">
              <option value="technologie" <?= !$category || $category === "technologie" ? "selected" : "" ?>>Technologie</option>
